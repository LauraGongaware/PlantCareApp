...
class PlantController {
    ...
    Plant(plantName: "Monstera", scientificName: "Monstera deliciosa", water: 3, sunlight: 4, description: "Monsteras are a popular houeplace native to the rainforests of Central America. Mature leaves will show increased fenestration or holes in the leaves. To help support the growth of your monstera, use a moss pole to support it. Monsteras need bright, filtered sun and allow the soil to dry beteween waterings", toxicity: true, staticImage: "monstera"),
        ...
        Plant(plantName: "Cactus", scientificName: "various", water: 1, sunlight: 5, description: "Native to desesrt environments, catcus are an easy to care for houseplant that will need lots of sun, but minimal water.", toxicity: true, staticImage: "cactus"),

        Plant(plantName: "Peace Lily", scientificName: "Spathiphyllum cochlearispathum", water: 4, sunlight: 5, description: "Native to the jungles of Columbia, the peace lily is a flowering houeplant with moderate sun but higher water needs. Fertilize every 2 weeks during the growing season.", toxicity: true, staticImage: "peacelily.png"),

        Plant(plantName: "Alocasia", scientificName: "Alocasia sp.", water: 4, sunlight: 4, description: "Native to the islands of the Philipines, Alocasias are plants with unique foliage. Alocasia thrive best with warm and humid indoor environments and are a more challenging houseplant to own.", toxicity: true, staticImage: "alocasia"),

        Plant(plantName: "Calathea", scientificName: "Calathea sp.", water: 4, sunlight: 4, description: "Native to tropical environments, calathea will tolerate moderate sun and too much can cause the leaves to burn. Calathea can be difficult to care for because of their higher humidity needs and sensitivity to tapwater", toxicity: false, staticImage: "calathea"),

        Plant(plantName: "African Violet", scientificName: "Saintpaulia ionntha", water: 3, sunlight: 4, description: "African violets are indoor flowering plant. As a flowering plant, they will need fertilizing every 2 weeks because producing flowers causes increased nutrient needs. Trim dead flowers to encourage growth. African violets have moderate sunlight and watering needs.", toxicity: false, staticImage: "africanviolet.png"),

        Plant(plantName: "Orchid", scientificName: "Orchidaceae", water: 3, sunlight: 3, description: "Orchids require moist, well draining soil with bright, indirect light. Allow orchids to dry between waterings. Fertilize weekly during the growing season. Orchids only need to be repotted every 1-2 years.", toxicity: false, staticImage: "orchid.png"),

        Plant(plantName: "Dieffenbachia", scientificName: "Dieffenbachia sp.", water: 3, sunlight: 3, description: "Dieffenbachia are native to South America and Mexico. They are shade tolerant with striking foliage. This plant is toxic to humans and animals. Allow the top 2 inches of soil to dry between waterings", toxicity: true, staticImage: "diffenbachia.png"),

        Plant(plantName: "Tradescantia", scientificName: "Tradescantia sp.", water: 3, sunlight: 3, description: "Tradescantia or wandering jewel is a houseplant that tolerates moderate sun producing attractive foliage. Too little sun cause legginess of the plant where pruning may be needed. Moderate water requirements.", toxicity: true, staticImage: "tradescantia.png"),
